...
// console.log(scene.getIn(['guides','horizontal']).entrySeq());
// console.log(snapElements);
  ...
  return (
    ...
    <g>
      ...
      <g className="tested__files" transform={`translate(0, ${scene.height}) scale(1, -1)`} id="svg-drawing-paper">
